...
public class AdminpanelController implements Initializable {
        ...
        cbUsers.setCellFactory(param -> new ListCell<User>(){
            ...
            protected void updateItem(User user,boolean empty){
                ...
                if(user==null || empty){
                    ...
                    setText(user.getCustomer().getFirstName()
                                +" "
    ...
    public void loadRoles() {
       cbRoles.setItems(FXCollections.observableArrayList(medicinesptv22.MedicineSptv22.ROLES.values()));
        //Настройка механизма отображения в ComboBox
        cbRoles.setCellFactory(param -> new ListCell<medicinesptv22.MedicineSptv22.ROLES>(){
            @Override
            protected void updateItem(medicinesptv22.MedicineSptv22.ROLES item,boolean empty){
        ...
        cbRoles.setButtonCell(new ListCell<medicinesptv22.MedicineSptv22.ROLES>() {
            @Override
            protected void updateItem(medicinesptv22.MedicineSptv22.ROLES item, boolean empty) {
                super.updateItem(item, empty);
        ...
        cbRoles.setOnAction(event->{
            this.selectedRole = (medicinesptv22.MedicineSptv22.ROLES) cbRoles.getValue();
